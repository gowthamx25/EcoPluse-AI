...
class TestEnvironmentalAnalytics(unittest.TestCase):
    ...
    def test_health_score_calculation(self) -> None:
        ...
        self.assertLess(result['health_score'], base_score, "Health score did not decrease during AQI spike.")
    ...
    def test_severity_levels(self) -> None:
        ...
        self.assertEqual(result['severity'], "Emergency", "Failed to classify hazardous AQI as 'Emergency'.")
